...
BASE_DIR = os.path.dirname(os.path.dirname(__file__))
 #BASE_DIR = '/Users/byeonseongjin/Documents/Python/skillshare/src',
...
SECRET_KEY = 'hb54j$*ubecm#h6$(5k8(d-%*24e_y6p%q33!sp!y^uot-#$zj'
...
TEMPLATE_DIRS =(
    ...
    #'/Users/byeonseongjin/Documents/Python/skillshare/static/templates/',
    )
